 ...
 */
final class Version20220810112709 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE finder (id INT AUTO_INCREMENT NOT NULL, movie_id INT DEFAULT NULL, user_id INT DEFAULT NULL, like_status TINYINT(1) DEFAULT NULL, INDEX IDX_C9EB34E68F93B6FC (movie_id), INDEX IDX_C9EB34E6A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE finder ADD CONSTRAINT FK_C9EB34E68F93B6FC FOREIGN KEY (movie_id) REFERENCES movie (id)');
